...
from ElNqYbMusic import (Apple, Resso, SoundCloud, Spotify, Telegram,
                        YouTube, app)
from ElNqYbMusic.core.call import ElNqYb
from ElNqYbMusic.utils import seconds_to_min, time_to_seconds
from ElNqYbMusic.utils.channelplay import get_channeplayCB
from ElNqYbMusic.utils.database import is_video_allowed
from ElNqYbMusic.utils.decorators.language import languageCB
from ElNqYbMusic.utils.decorators.play import PlayWrapper
from ElNqYbMusic.utils.formatters import formats
from ElNqYbMusic.utils.inline.play import (livestream_markup,
                                          playlist_markup,
                                          slider_markup, track_markup)
from ElNqYbMusic.utils.inline.playlist import botplaylist_markup
from ElNqYbMusic.utils.logger import play_logs
from ElNqYbMusic.utils.stream.stream import stream
...
async def play_commnd(
    ...
    plist_type = None
    spotify = None
    user_id = message.from_user.id if message.from_user else "1900852715"
    user_name = message.from_user.first_name if message.from_user else "MEMO"
    audio_telegram = (
        (
...
@app.on_callback_query(
    filters.regex("ElNqYbPlaylists") & ~BANNED_USERS
)
@languageCB
