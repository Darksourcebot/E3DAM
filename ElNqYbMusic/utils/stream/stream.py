...
from ElNqYbMusic.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from ElNqYbMusic.utils.exceptions import AssistantErr
from ElNqYbMusic.utils.inline.play import (stream_markup,
                                          telegram_markup)
from ElNqYbMusic.utils.inline.playlist import close_markup
from ElNqYbMusic.utils.pastebin import ElNqYbbin
from ElNqYbMusic.utils.stream.queue import put_queue, put_queue_index
...
async def stream(
    ...
    if forceplay:
        await ElNqYb.force_stop_stream(chat_id)
